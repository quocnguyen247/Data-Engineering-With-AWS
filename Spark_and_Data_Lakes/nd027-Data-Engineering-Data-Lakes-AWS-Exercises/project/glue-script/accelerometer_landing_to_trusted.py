...
DropFields_node1717907947351 = DropFields.apply(frame=JoinCustomer_node1717873438029, paths=["serialNumber", "shareWithPublicAsOfDate", "birthDay", "registrationDate", "shareWithResearchAsOfDate", "customerName", "shareWithFriendsAsOfDate", "email", "lastUpdateDate", "phone"], transformation_ctx="DropFields_node1717907947351")

# Script generated for node Amazon S3
AmazonS3_node1717872588118 = glueContext.write_dynamic_frame.from_options(frame=DropFields_node1717907947351, connection_type="s3", format="json", connection_options={"path": "s3://cd0030bucketuswest2/accelerometer/trusted/", "partitionKeys": []}, transformation_ctx="AmazonS3_node1717872588118")
